...
INSERT INTO CITIES(CITY_ID) VALUES (0);
...
INSERT INTO PROGRAMS(PROGRAM_ID) VALUES (0);

INSERT INTO EDUCATION(USER_ID)
SELECT USER_ID
FROM USER_INFORMATION
WHERE INSTITUTION_NAME IS NULL OR PROGRAM_CONCENTRATION IS NULL OR PROGRAM_DEGREE IS NULL;
...
INSERT INTO USER_EVENTS(EVENT_ID, EVENT_CREATOR_ID, EVENT_NAME, EVENT_TAGLINE, EVENT_DESCRIPTION, EVENT_HOST, EVENT_TYPE, EVENT_SUBTYPE, EVENT_LOCATION, EVENT_CITY_ID, EVENT_START_TIME, EVENT_END_TIME)
SELECT EVENT_ID, EVENT_CREATOR_ID, EVENT_NAME, EVENT_TAGLINE, EVENT_DESCRIPTION, EVENT_HOST, EVENT_TYPE, EVENT_SUBTYPE, EVENT_LOCATION, 0, EVENT_START_TIME, EVENT_END_TIME
FROM EVENT_INFORMATION
WHERE EVENT_CITY IS NULL OR EVENT_STATE IS NULL OR EVENT_COUNTRY IS NULL;
