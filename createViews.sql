...
FROM 
USERS
LEFT JOIN (USER_CURRENT_CITY LEFT JOIN CITIES
ON CITIES.CITY_ID=USER_CURRENT_CITY.CITY_ID)

LEFT JOIN (USER_HOMETOWN_CITY LEFT JOIN CITIES
ON CITIES.CITY_ID=USER_HOMETOWN_CITY.CITY_ID)

LEFT JOIN (EDUCATION LEFT JOIN PROGRAMS
ON PROGRAMS.PROGRAM_ID=EDUCATION.PROGRAM_ID);
