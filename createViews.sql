...
AS SELECT UC.USER_ID, UC.FIRST_NAME, UC.LAST_NAME, UC.YEAR_OF_BIRTH, UC.MONTH_OF_BIRTH, UC.DAY_OF_BIRTH, UC.GENDER, UC.CU_CITY, UC.CU_STATE, UC.CU_COUNTRY, UC.HC_CITY, UC.HC_STATE, UC.HC_COUNTRY, EP.INSTITUTION, EP.PROGRAM_YEAR, EP.CONCENTRATION, EP.DEGREE
FROM((
